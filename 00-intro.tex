...
%\begin{figure}[ht]
%    \centering
%    \includegraphics[width=1\textwidth, height=300px, width=300px]{images/RiccardoMatterhorn.jpeg}
%    \caption{L'autore \'e appena andato a sciare e vuole vedere se e' capace di accludere un'immagine in LateX}
%    \label{fig1}
%\end{figure}
