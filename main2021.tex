...
{\rule{1ex}{1ex}
	...
	{\emph Prima di passare oltre, \'e opportuno che sappiate rispondere alle seguenti domande (se 
  non sapete rispondere ad esse, difficilmente riuscirete a capire ci\'o che segue).}\\
	\hspace{\stretch{1}}}
{\hspace{\stretch{1}}%
	\rule{1ex}{1ex}}
...
\begin{document}
  ...
  \input{02-numeri}
  \input{03-funzioni}
  \input{04-trigonometria} 
  \input{05-limiti}
  \input{06-derivate} 
  \input{07-equazionidifferenziali} 
  \input{08-taylor} 
% \input{statistica}
% \input{09-integrali} 
% \input{10-utilita}
% \input{11-numeriprimi}
% \input{99-autore}
\end{document}