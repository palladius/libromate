...
\prerequisitocovid{Per \em{calcolare} derivate, dovete conoscere il concetto di Limite 
ed aver fatto ore di esercizi con essi. Per capire le derivate, questo non e' necessario.}
...
In questo caso l'andazzo del vostro investimento e' chiaramente l'ultimo valore meno il primo (1 \EUR ) in 12 mesi. Avete 
...
% Proprio ora che stavate cominciando ad abituarvi alla notazione..}.
...
% {\emph (1) Quanti soldi avremo tra un minuto? (2) Tra quanto tempo avremo 1000 soldi (una specie del nostro 'primo miliardo')? (3) Tra quanto
...
% danno per scontato quello che {\emph voi} date per scontato. Io vi ho avvisati...
